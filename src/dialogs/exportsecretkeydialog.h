...
#ifndef __KLEOPATRA_DIALOGS_EXPORTSECRETKEYDIALOG_H__
#define __KLEOPATRA_DIALOGS_EXPORTSECRETKEYDIALOG_H__
...
#endif /* __KLEOPATRA_DIALOGS_EXPORTSECRETKEYDIALOG_H__ */
