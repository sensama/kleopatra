...
static std::vector<QAction *> actionsForCardSlot(SmartCard::AppType appType)
{
    ...
    case AppType::PIVApp:
        return SmartCardActions::instance()->actions({
            u"card_all_show_certificate_details"_s,
            u"card_piv_generate_key"_s,
            u"card_piv_write_key"_s,
            u"card_piv_write_certificate"_s,
            u"card_piv_read_certificate"_s,
            u"card_piv_create_csr"_s,
        });
    case AppType::NoApp:
        break;
    };
