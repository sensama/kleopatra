    ...
    : mActionCollection{std::make_unique<KActionCollection>(nullptr, u"smartcards"_s)}
{
    ...
    // card slot actions (PIV)
    {
        QAction *action = mActionCollection->addAction(u"card_piv_generate_key"_s);
    ...
    {
        QAction *action = mActionCollection->addAction(u"card_piv_write_key"_s);
    ...
    {
        QAction *action = mActionCollection->addAction(u"card_piv_write_certificate"_s);
    ...
    {
        QAction *action = mActionCollection->addAction(u"card_piv_read_certificate"_s);
    ...
    {
        QAction *action = mActionCollection->addAction(u"card_piv_create_csr"_s);
